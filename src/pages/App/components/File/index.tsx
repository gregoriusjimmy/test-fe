...
const File = ({file,onRemove}:{file:File,onRemove:(file:File)=>void}) => {
 const {ref,isHovered}= useHover<HTMLDivElement>()
  ...
  const handleRemove = ()=>{
    ...
    return (
      <div ref={ref} onClick={handleRemove} className={cn("relative flex items-center justify-center",isHovered &&'cursor-pointer')}>
        {isHovered && <> 
